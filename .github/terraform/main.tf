...
# Note: Commenting out ECS-related infra.
# Switching to EKS to practice stuff that will be used in my new job.
# All the ECS infra that I created is below this point;
# For future reference, I didn't quite get it to the point that I could send a request to the container running in ECS.
